  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      children: <Widget>[
        ...
        (_mode != DatePickerMode.day)?_DatePickerModeToggleButton(
          mode: _mode,
...
class _MonthPicker extends StatefulWidget {
  ...
  _MonthPicker({
    ...
    required this.handleModeChanged,
    this.selectableDayPredicate,
  ...
  final VoidCallback handleModeChanged;
              ...
              children: <Widget>[
                ...
                SizedBox(
                  ...
                  child: _DatePickerModeToggleButton(
                    ...
                    onTitlePressed: widget.handleModeChanged,
                  ),
                ),
                IconButton(
